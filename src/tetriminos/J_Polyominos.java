...
/**
 * this class represents the stone looking like a "J"
 *
 * @author RAMRAMI
 */
public class  J_Polyominos extends Seven_Tetriminos_Stone implements Serializable
{
	...
	public J_Polyominos()
	{
		...
		mat = new All_Tetriminos_ColorBlock[][]
		       {{new All_Tetriminos_ColorBlock(whito, wstr, wint),new All_Tetriminos_ColorBlock(whito, wstr, wint),new All_Tetriminos_ColorBlock(whito, wstr, wint),new All_Tetriminos_ColorBlock(whito, wstr, wint)},
				{new All_Tetriminos_ColorBlock(colo, colstr, colint),new All_Tetriminos_ColorBlock(whito, wstr, wint),new All_Tetriminos_ColorBlock(whito, wstr, wint),new All_Tetriminos_ColorBlock(whito, wstr, wint)},
