...
/**
 * this class represents the stone looking like a "L"
 *
 * @author RAMRAMI
 */
public class  L_Polyominos extends Seven_Tetriminos_Stone implements Serializable
{
	...
	public L_Polyominos()
	{
		...
		mat = new All_Tetriminos_ColorBlock[][]
				...
				{new All_Tetriminos_ColorBlock(whito, wstr, wint),new All_Tetriminos_ColorBlock(whito, wstr, wint),new All_Tetriminos_ColorBlock(colo, colstr, colint),new All_Tetriminos_ColorBlock(whito, wstr, wint)},
				{new All_Tetriminos_ColorBlock(colo, colstr, colint),new All_Tetriminos_ColorBlock(colo, colstr, colint),new All_Tetriminos_ColorBlock(colo, colstr, colint),new All_Tetriminos_ColorBlock(whito, wstr, wint)},
				{new All_Tetriminos_ColorBlock(whito, wstr, wint),new All_Tetriminos_ColorBlock(whito, wstr, wint),new All_Tetriminos_ColorBlock(whito, wstr, wint),new All_Tetriminos_ColorBlock(whito, wstr, wint)}};
	}
	...
	public void rotate()
	{
		if (state == 0)
		{
			...
			mat[1][0].setColor(colo, colstr, colint);
			mat[1][1].setColor(colo, colstr, colint);
			mat[1][2].setColor(whito, wstr, wint);
			mat[2][0].setColor(whito, wstr, wint);
			mat[2][2].setColor(whito, wstr, wint);
			mat[3][1].setColor(colo, colstr, colint);
			...
			if(checkCollision())
			{
				...
				mat[1][1].setColor(whito, wstr, wint);
		...
		else if (state == 1)
		{
			...
			mat[2][0].setColor(colo, colstr, colint);
			mat[2][2].setColor(colo, colstr, colint);
			mat[3][0].setColor(colo, colstr, colint);
			mat[3][1].setColor(whito, wstr, wint);
			...
			if(checkCollision())
			{
				...
				mat[2][0].setColor(whito, wstr, wint);
				mat[2][2].setColor(whito, wstr, wint);
				mat[3][0].setColor(whito, wstr, wint);
				mat[3][1].setColor(colo, colstr, colint);
