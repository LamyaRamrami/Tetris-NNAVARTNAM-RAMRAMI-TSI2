...
/**
 * this class represents the stone looking like a "T"
 *
 * @author RAMRAMI
 */
public class T_Polyomino extends Seven_Tetriminos_Stone implements Serializable
{
	...
	public T_Polyomino()
	{
		...
		mat = new All_Tetriminos_ColorBlock[][]
				...
				{new All_Tetriminos_ColorBlock(whito, wstr, wint),new All_Tetriminos_ColorBlock(colo, colstr, colint),new All_Tetriminos_ColorBlock(whito, wstr, wint),new All_Tetriminos_ColorBlock(whito, wstr, wint)},
